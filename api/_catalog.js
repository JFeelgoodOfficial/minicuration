...
const LIMITED = [
  ...
  {
    slug: 'path-of-privilege', title: 'Path of Privilege', medium: 'Mixed Media',
    quote: 'Two brushes dragging a red trail across gold leaf – a visual reminder of how history, race, and power are still painting the world we walk through.',
    description: [
      'Two brushes dragging a red trail across gold leaf – a visual reminder of how history, race, and power are still painting the world we walk through.',
      'Featured in Thought Entropy.',
    ],
    painting: 'assets/images/opt/path of privilege.webp',
  },
  {
...
const OPEN = [
  { slug: 'adventure-awaits', title: 'Adventure Awaits', painting: A + 'thumbs/Adventure Awaits.webp',
    description: ['A dark figure steps through a pale blue archway cut into a violet stone tunnel, one hand braced on the wall. Shards of pink crystal crowd the passage beside them, and the light past the opening looks like open water.'] },
  ...
  { slug: 'chelsea-contemporary', title: 'Chelsea Contemporary', painting: A + 'full/Chelsea Contemporary.webp',
    description: ['A pale woman in a wide striped hat stares straight out from a field of blue and crimson flecks. Her long hair parts like curtains over her chest, where three grey cats lounge and leap as if they live inside her.'] },
  ...
  { slug: 'le-monarch', title: 'Le Monarch', painting: A + 'full/Le Monarch.webp',
    description: ['A woman with a pale face and red lips, built from heavy, fast strokes of grey, blue and black. Green foliage climbs the edge of the frame and a small red and yellow butterfly rests near her shoulder.'] },
  { slug: 'liberty', title: 'Liberty', painting: A + 'thumbs/Liberty.webp',
    description: ['A lone figure stands on red ground under a bright blue sky, one arm raised toward a pale sun. Yellow-edged clouds and long diagonal strokes sweep across the canvas, giving the whole scene the push of a strong wind.'] },
  ...
  { slug: 'the-sun-room', title: 'The Sun Room', painting: A + 'full/JFeelgood painting 073.webp',
    description: ['A pale gold disc rises out of a swirl of poured crimson, pink and black paint. The piece sits inside a hand-painted frame of gold, green and red pattern, like a window into a very warm room.'] },
  ...
  { slug: 'wild-stripes', title: 'Wild Stripes', painting: A + 'thumbs/JFeelgood painting 135.webp',
    description: ['A woman drawn in fine white line, one hand at her chest, half hidden among jagged stripes of deep red, black and cream. The stripes read like tall grass or an animal hide, and she seems at home inside them.'] },
  { slug: 'blue-curve', title: 'Blue Curve', painting: A + 'thumbs/JFeelgood painting 137.webp',
    description: ['A figure traced in a single thin gold line against deep blue, the body turned away and reduced to its curves. The dark ground and bright line keep the piece simple and bold.'] },
  { slug: 'golden-repose', title: 'Golden Repose', painting: A + 'thumbs/JFeelgood painting 140.webp',
    description: ['A golden figure lies back across diagonal bands of maroon and teal, arms raised and long hair falling loose. The stripes run the length of the canvas and carry the eye along the reclining body.'] },
  { slug: 'checkmate', title: 'Checkmate', painting: A + 'thumbs/JFeelgood painting 141.webp',
    description: ['A red and black checkerboard bends and warps as if it were fabric, its white grid lines pulling around a figure with long striped hair at the center. The game board has become the whole world.'] },
  { slug: 'rooted', title: 'Rooted', painting: A + 'thumbs/JFeelgood painting 143.webp',
    description: ['A mural of a broad tree painted into the corner of a room, its trunk rising from the floor and its leafy canopy spreading across both walls. A painting you could stand under.'] },
  ...
  { slug: 'blue-siren', title: 'Blue Siren', painting: A + 'thumbs/JFeelgood painting 149.webp',
    description: ['A woman’s face and shoulders emerge in deep blue and violet, her long hair lit in streaks of white. The high contrast makes her look lit from underwater, or seen by moonlight.'] },
  ...
  { slug: 'ember', title: 'Ember', painting: A + 'thumbs/JFeelgood painting 151.webp',
    description: ['A woman seen from behind, her bare back painted in burning orange and gold against a red field and a textured teal wall. One hand lifts her hair; her face stays turned away.'] },
  { slug: 'evening-stripes', title: 'Evening Stripes', painting: A + 'thumbs/JFeelgood painting 152.webp',
    description: ['A woman with long dark hair looks over her shoulder against a glowing orange-red ground. A black cloth traced with fine blue stripes wraps across the lower half of the canvas.'] },
  { slug: 'blue-temple', title: 'Blue Temple', painting: A + 'thumbs/JFeelgood painting 153.webp',
    description: ['A small domed pavilion sits at the center of a burst of poured blue and white paint, as though a storm were breaking around it. The photograph shows the work in its carved wooden frame.'] },
  ...
  { slug: 'silver-current', title: 'Silver Current', painting: A + 'thumbs/JFeelgood painting 156.webp',
    description: ['Poured ribbons of silver, black, pink and white run across the canvas like water in a fast river. The photograph shows the piece hanging in its copper frame, with a fern at the edge.'] },
  { slug: 'shore-pup', title: 'Shore Pup', painting: A + 'full/JFeelgood painting 157.webp',
    description: ['A small glittered red dinosaur stands on a beach of yellow and blue brushstrokes. The shore stretches out in long horizontal bands, and the little creature has the whole place to itself.'] },
  ...
  { slug: 'blue-canopy', title: 'Blue Canopy', painting: A + 'thumbs/JFeelgood painting 164.webp',
    description: ['A sculpted blue hand reaches down from a canopy of deep blue discs, crossed by strips of golden wood. Green and teal paint spreads beneath it like the ground it is reaching for.'] },
