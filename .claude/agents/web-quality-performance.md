...
description: Optimizes web performance for faster loading and better user experience — Core Web Vitals, resource loading, images, fonts, caching, runtime performance. Only use when explicitly requested.
