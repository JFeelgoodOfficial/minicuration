...
description: Comprehensive web quality audit across performance, accessibility, SEO, and best practices based on Lighthouse standards. Only use when explicitly requested.
