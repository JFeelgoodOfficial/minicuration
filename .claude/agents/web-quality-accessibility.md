...
description: Audits and improves web accessibility following WCAG 2.2 — POUR principles, color contrast, keyboard navigation, ARIA, forms, and new 2.2 criteria. Only use when explicitly requested.
