...
description: Optimizes Core Web Vitals (LCP, INP, CLS) — loading, interactivity, and visual stability for Google Search ranking and user experience. Only use when explicitly requested.
